(function(root, factory) {
  ...
  var pxDemo = (function() {
    ...
    var BACKGROUNDS = [
      'public/demo/bgs/1.jpg',
      'public/demo/bgs/2.jpg',
      'public/demo/bgs/3.jpg',
      'public/demo/bgs/4.jpg',
      'public/demo/bgs/5.jpg',
      'public/demo/bgs/6.jpg',
      'public/demo/bgs/7.jpg',
      'public/demo/bgs/8.jpg',
      'public/demo/bgs/9.jpg',
    ];
    ...
    function setTheme(themeName) {
      ...
      var themePath = 'public/css/themes/' + themeName + (_isRtl ? '.rtl' : '') + '.min.css';

      var linksToLoad = [];

      // Switch between light and dark public
    ...
    function initializeDemoSidebar(container, skipFooter) {
      ...
      for (var i = 0, l = THEMES.length; i < l; i++) {
        content += '<label class="px-demo-themes-item">';
          ...
          content += '<img src="public/demo/themes/' + THEMES[i] + '.png" class="px-demo-themes-thumbnail">';
